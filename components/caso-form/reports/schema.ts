...
export const assistantSFormSchema = z.object({
...
export type ReportsFormData = z.infer<typeof reportsFormSchema>;
export type AssistantFormData = z.infer<typeof assistantSFormSchema>;
