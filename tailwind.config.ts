  ...
  theme: {
  	extend: {
  		...
  		colors: {
  			...
  			'panel-badge-importance-yellow': 'hsl(var(--panel-badge-importance-yellow))',
  			'panel-badge-importance-yellow-bg': 'hsl(var(--panel-badge-importance-yellow-bg))',
  			...
  			'papeis-role-active-indicator': 'hsl(var(--papeis-role-active-indicator))',
  			'papeis-module-icon-active-bg': 'hsl(var(--papeis-module-icon-active-bg))',
  			'papeis-module-icon-muted-bg': 'hsl(var(--papeis-module-icon-muted-bg))',
  			'papeis-perm-selected-bg': 'hsl(var(--papeis-perm-selected-bg))',
  			'papeis-perm-selected-border': 'hsl(var(--papeis-perm-selected-border))',
  			'papeis-button-dark-bg': 'hsl(var(--papeis-button-dark-bg))',
  			'papeis-button-dark-bg-hover': 'hsl(var(--papeis-button-dark-bg-hover))',
  		...
  		backgroundImage: {
  			'login-gradient': 'linear-gradient(125.79deg, hsl(var(--login-bg-start)) 0%, hsl(var(--login-bg-end)) 100%)',
  			'login-button-gradient': 'linear-gradient(to right, hsl(var(--login-button-from)), hsl(var(--login-button-to)))'
  		},
  		borderRadius: {
  			lg: 'var(--radius)',
