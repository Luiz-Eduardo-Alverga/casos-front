...
ALTER TABLE "acquirer_status" ADD CONSTRAINT "acquirer_status_recommended_device_id_devices_id_fk" FOREIGN KEY ("recommended_device_id") REFERENCES "public"."devices"("id") ON DELETE no action ON UPDATE no action;